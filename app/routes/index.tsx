            ...
            <Card className="bg-white">
              ...
              <ul className="flex gap-3">
                <li className="grow">
                  <button
                    type="button"
                    className="border border-red-500 bg-white px-3 py-2 rounded w-full hover:drop-shadow"
                  >
                    Absent
                  </button>
                </li>
                <li className="grow">
                  <button
                    type="button"
                    className="border border-green-500 bg-white px-3 py-2 rounded w-full hover:drop-shadow"
                  >
                    Attending
                  </button>
                </li>
          ...
          <li>
            <Card className="bg-white">
              ...
              <Link to="/sessions/1234567">
                <div className="border border-slate-200  bg-white px-3 py-2 rounded text-center hover:box-shadow">
                  Details
                </div>
              </Link>
            </Card>
